...
int main( int argc, char **argv )
{
	...
	while (!glfwWindowShouldClose(im->m_window))
	{
		...
		ImGui::SliderFloat("rot_w", &rot_w, -1.0f, 1.0f);
		ImGui::SliderFloat("rot_x", &rot_x, -1.0f, 1.0f);
		ImGui::SliderFloat("rot_y", &rot_y, -1.0f, 1.0f);
		ImGui::SliderFloat("rot_z", &rot_z, -1.0f, 1.0f);
		MiniGL::m_rotation.w() = -(Real)rot_w;
		MiniGL::m_rotation.x() = -(Real)rot_x;
		MiniGL::m_rotation.y() = -(Real)rot_y;
		MiniGL::m_rotation.z() = -(Real)rot_z;
