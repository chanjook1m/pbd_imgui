...
GLFWwindow* MiniGL::init(int argc, char** argv, const int width, const int height, const int posx, const int posy, const char* name)
{
	fovy = 60;
	znear = 0.5f;
	zfar = 1000;
...
void MiniGL::key_callback(GLFWwindow* window, int k, int scancode, int action, int mods)
{
	//if (TwEventKeyboardGLUT(k, x, y))  // send event to AntTweakBar
//		return;
